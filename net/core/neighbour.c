								 ...
								 struct net_device *dev, bool want_ref)
{
	...
	//xj:调用 arp表项的constructor，它会设置ARP操作：arp_hh_ops
...
static __inline__ int neigh_max_probes(struct neighbour *n)
{
	...
	return (n->nud_state & NUD_PROBE) ? NEIGH_VAR(p, UCAST_PROBES) : NEIGH_VAR(p, UCAST_PROBES) + NEIGH_VAR(p, APP_PROBES) + NEIGH_VAR(p, MCAST_PROBES);
}
